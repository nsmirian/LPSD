%% script for PolariX time calibration for screen 8FLFDUMP
%
...
function get_timecalibration_fast_double_OTR9FL2XTDS(start_actuator, end_actuator, block_laser, num_bgr, num_sig, num_actuator, msgLoc, comment)      
%% config
...
%     comment         = 'FL2 PolariX Measurement';
    ...
    % XTDS phase
%     start_actuator  = -171; % in deg
%     end_actuator    = -168; % in deg

    num_actuator    = num_actuator*2;    % set points, *2 for way forth and back
...
%% 
    ...
    % addresses
    name_script             = 'get_timecalibration_fast_double_OTR9FL2XTDS';
    ...
    pixelformat=doocswrite([addr_cam, 'FORMAT.OUT'], 1); % vogtm 22.03.2023 : mono8 sucks ! mono16 kicks ass !
...
%% prepare actuator scan list
    ...
    % scan list
    scan_list_set       = [linspace(start_actuator, end_actuator, num_actuator/2), ...
                           linspace(end_actuator, start_actuator, num_actuator/2)];
    % rbv container
