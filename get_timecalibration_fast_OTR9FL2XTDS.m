...
function get_timecalibration_fast_OTR9FL2XTDS(start_actuator, end_actuator, block_laser, num_bgr, num_sig, num_actuator, msgLoc, comment)   
%% config

%     comment         = 'Test fast script';
    ...
    % XTDS phase
%     start_actuator  = -15; % in deg
%     end_actuator    = -13; % in deg
% 
...
%% 
    ...
    % addresses
    name_script             = 'get_timecalibration_fast_OTR9FL2XTDS';
