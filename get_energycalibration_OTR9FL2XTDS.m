...
function get_energycalibration_OTR9FL2XTDS(start_actuator, end_actuator, block_laser, num_bgr, num_sig, num_actuator, msgLoc, comment)    
%% config
...
%% 
    ...
    % addresses
    name_script             = 'get_energycalibration_OTR9FL2XTDS';
